...
- `docs/xhs-maomao-codex-pet.md` - a Chinese write-up draft for the Maomao example.
...
- User-called-out traits, like Maomao's messy head tufts, should become prompt invariants across the canonical base and every animation row.

## Example Output

Open `xhs-cards/index.html` in a browser to see the Maomao case study cards.
